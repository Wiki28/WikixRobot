...
import WikiRobot.modules.sql.connection_sql as sql
from WikiRobot import dispatcher, DRAGONS, DEV_USERS
from WikiRobot.modules.helper_funcs import chat_status
