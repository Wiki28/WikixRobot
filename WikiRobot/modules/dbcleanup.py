...
import WikiRobot.modules.sql.global_bans_sql as gban_sql
import WikiRobot.modules.sql.users_sql as user_sql
from WikiRobot import DEV_USERS, OWNER_ID, dispatcher
