...
LOGGER.info("Wiki is starting. | An Wiki Projects Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/Wiki28 (t.me/WikiTapiOrang)")
...
if ENV:
    ...
    OWNER_USERNAME = os.environ.get("OWNER_USERNAME", "WikiTapiOrang")
...
from WikiRobot.modules.helper_funcs.handlers import (
