...
from WikiRobot.modules import ALL_MODULES
from WikiRobot.modules.helper_funcs.chat_status import is_user_admin
from WikiRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="My Darling", url="https://t.me/terserah_wiki"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Muscat To Your Group ➗", url="t.me/WikiTapiBot?startgroup=new"),
    ],
]
...
DONATE_STRING = """Heya, senang mendengar Anda ingin menyumbang!
 Anda dapat mendukung proyek dengan menghubungi @terserah_wiki \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("WikiRobot.modules." + module_name)
